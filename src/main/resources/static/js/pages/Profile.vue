    ...
    <v-container>
        <v-layout justify-space-around>
            <v-flex :xs6="!$vuetify.breakpoint.xsOnly">
                <div class="title mb-3">{{$t('userProfile')}}</div>
                <v-layout row justify-space-between>
                    ...
                    <v-flex class="px-1">
                        <v-layout column>
                            ...
                            <v-flex>{{profile.subscription && profile.subscription.length}} subscriptions</v-flex>
                ...
                >
                    {{isISubscribed ? $t('unsubscribe') : $t('subscribe')}}
                </v-btn>
            </v-flex>
        </v-layout>
    </v-container>
